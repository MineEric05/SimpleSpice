...
void getTheveninCircuit(short &,vector<Resistor> [],double [],double []);
    ...
    while(Type!=6){
        ...
        switch(Type){
            ...
            case 5:
                ...
                break;
            case 7:
                getTheveninCircuit(Stage,Map,Voltage,Current);
                break;
            default:
                break;
        }
...
void getType(short &Type){
    ...
    cout<<"Please type 7 to output Thevenin equivalence circuit"<<endl;
    cout<<"Enter your selection Here:";

    while(1){
        cin>>Type;
        if( cin.fail() || Type>7 || Type<0 ){
            cin.clear();
            cin.sync();
...
void getTheveninCircuit(short &Stage,vector<Resistor> Map[],double Voltage[],double Current[]){
    ...
    double Resistance_S = 0;
    double Resistance_P = 0;

    for(short i = 0; i<=2*(Stage-1); i+=2){
        getTotalResistor(Resistance_S,Map[i]);
        getTotalResistor(Resistance_P,Map[i+1]);
        Resistance_S = (Resistance_S*Resistance_P)/(Resistance_S+Resistance_P);
        Resistance_P = 0;
    }
    cout<<"Exporting the file... "<<endl;

    OutputFile<<"***Thevenin equivalence circuit***"<<endl;
    OutputFile<<"Rth = "<<getUnit(Resistance_S,' ',1,4)<<endl;
    OutputFile<<"Vth = "<<getUnit(Voltage[Stage],'v',1,4)<<endl;
